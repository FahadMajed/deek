...
class Formatter {
  ...
  static String formatResearchId(String researcherId) =>
      researcherId + DateTime.now().millisecondsSinceEpoch.toString();
  ...
  static String formatSinceLastMessage(DateTime chatLastMessageDate) {
    final duration = DateTime.now().difference(chatLastMessageDate);
